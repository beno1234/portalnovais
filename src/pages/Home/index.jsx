...
const Home = () => {
  ...
  const {
    featuredList:
      listFeaturedAdvertisement /* , isLoading: isLoadingAdvertisement, error: errorAdvertisement */,
  ...
  return (
    <>
      ...
      <div onClick={isSideBarOpen ? closeSideBar : undefined}>
        ...
        <Publicidade types={"maxBanner"} place={"home"} limit={1} />

        {(!isLoadingCategory || !isLoadingLocation) &&
          ...
          <>
            <div className="ui container">
              <div className="ui vertical section center aligned segment">
                ...
                <div className="ui equal width stackable grid">
                  <div className="center aligned row">
                    {listFeaturedAdvertisement.map((advertisement, index) => (
                      <div className="featured column" key={`featAd${index}`}>
                ...
                {featuredCategories.map((category) => {
                  return (
                    <FeaturedCategoryCard
                      ...
                      onSearch={onSearchAdvertisements}
                    />
                  );
                })}
              </div>
