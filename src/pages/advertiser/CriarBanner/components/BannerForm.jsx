...
const BannerForm = ({
  ...
  const validateValues = (values) => {
    ...
    if (!values.type) {
      ...
      if (
        values.type === "maxBanner" &&
        (!values.bannerPlaces || values.bannerPlaces?.length <= 0)
      ) {
            ...
            <form className="ui equal width form" onSubmit={handleSubmit}>
              ...
              <div className="field">
                    ...
                    <div className="content">
                      ...
                      {coverImageError && (
                        <div className="ui right floated">
                          <div
                            className="ui button"
                            onClick={() => onCoverUploadClick(coverImageFile)}
                          >
                            Tentar novamente
                          </div>
                        </div>
                ...
                <p style={{ fontSize: "0.85em" }}>
                  Formato de arquivo recomendado: GIF animado
                </p>
                <Condition when="type" is="maxBanner">
                  <p style={{ fontSize: "0.85em" }}>
                    Tamanho recomendado: <b>800x96 pixels</b>
                  </p>
                </Condition>
                <Condition when="type" is="featured">
                  <p style={{ fontSize: "0.85em" }}>
                    Tamanho recomendado: <b>174x280 pixels</b>
                  </p>
                </Condition>
                <Condition when="type" is="miniBanner">
                  <p style={{ fontSize: "0.85em" }}>
                    Tamanho recomendado: <b>174x70 pixels</b>
                  </p>
                </Condition>
              </div>
              ...
              <button
                className={`ui right floated secondary submit button ${
                  (disableSubmit ||
                    invalid ||
                    coverImageError ||
                    coverImageLoading ||
