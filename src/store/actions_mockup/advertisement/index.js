import advertisements from '../../../apis/mockups/advertisements';
...
export const fetchAdvertisement = (id) => async dispatch => {
    ...
    try {
        ...
        toast.error(`Não foi possível carregar os dados do anúncio: ${err.response?.data?.message ? err.response?.data?.message : err.message}`, {
...
export const fetchPublicAdvertisements = (params) => async dispatch => {
    ...
    try {
        ...
        const response = {};
        response.data = advertisements;//await api.get(url, config);
...
export const fetchAdvertisementsInReview = () => async dispatch => {
    ...
    try {
        ...
        const response = {};
        response.data = advertisements;//await api.get("/advertisements?status=review", config);
...
export const fetchFeaturedAdvertisements = (params) => async dispatch => {
    ...
    try {
        ...
        const response = {};
        response.data = advertisements;//await api.get(url);
...
export const fetchAdvertisements = (params) => async dispatch => {
    ...
    try {
        ...
        toast.error(`Não foi possível carregar os anúncios: ${err.response?.data?.message ? err.response?.data?.message : err.message}`, {
            position: "bottom-right",
            autoClose: 7000,
            hideProgressBar: false,
            closeOnClick: true,
...
export const allowAdvertisement = (id) => async dispatch => {
    ...
    try {
        ...
        dispatch(setError({
            message: "Não foi possível aprovar o anúncio.",
            code: err.code
        }));
...
export const blockAdvertisement = (id) => async dispatch => {
    ...
    try {
        ...
        dispatch(setError({
            message: "Não foi possível bloquear o anúncio.",
            code: err.code
        }));
...
export const disableAdvertisement = (id) => async dispatch => {
    ...
    try {
        ...
        toast.error(`Não foi possível desativar o anúncio: ${err.response?.data?.message ? err.response?.data?.message : err.message}`, {
            position: "bottom-right",
            autoClose: 7000,
            hideProgressBar: false,
            closeOnClick: true,
