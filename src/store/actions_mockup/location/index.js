...
export const fetchLocation = (id) => async dispatch => {
    ...
    try {
        ...
        toast.error(`Não foi possível carregar os dados da localização: ${err.response?.data?.message ? err.response?.data?.message : err.message}`, {
...
export const fetchLocations = (params) => async dispatch => {
    ...
    try {
        ...
        toast.error(`Não foi possível carregar as localizações: ${err.response?.data?.message ? err.response?.data?.message : err.message}`, {
            position: "bottom-right",
            autoClose: 7000,
            hideProgressBar: false,
            closeOnClick: true,
...
export const createLocation = (formValues) => async dispatch => {
    ...
    try {
        ...
        dispatch(setError({
            message: "Não foi possível criar a localização.",
            code: err.code
        }));
...
export const disableLocation = (id) => async dispatch => {
    ...
    try {
        ...
        dispatch(setError({
            message: "Não foi possível desativar a localização.",
            code: err.code
        }));
