import categories from '../../../apis/mockups/category';
...
export const fetchCategory = (id) => async dispatch => {
    ...
    try {
        ...
        toast.error(`Não foi possível carregar os dados da categoria: ${err.response?.data?.message ? err.response?.data?.message : err.message}`, {
...
export const fetchCategories = (params) => async dispatch => {
    ...
    try {
        ...
        const response = {};
        response.data = categories;//await api.get(url, config);
        ...
        toast.error(`Não foi possível carregar as categorias: ${err.response?.data?.message ? err.response?.data?.message : err.message}`, {
            position: "bottom-right",
            autoClose: 7000,
            hideProgressBar: false,
            closeOnClick: true,
...
export const createSubCategory = (formValues) => async dispatch => {
    ...
    try {
        ...
        dispatch(setError({
            message: "Não foi possível criar a subcategoria.",
            code: err.code
        }));
