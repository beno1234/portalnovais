...
export const fetchUser = (id) => async dispatch => {
    ...
    try {
        ...
        toast.error(`Não foi possível carregar os dados do usuário: ${err.response?.data?.message ? err.response?.data?.message : err.message}`, {
...
export const fetchUsers = (params) => async dispatch => {
    ...
    try {
        ...
        toast.error(`Não foi possível carregar os usuários: ${err.response?.data?.message ? err.response?.data?.message : err.message}`, {
            position: "bottom-right",
            autoClose: 7000,
            hideProgressBar: false,
            closeOnClick: true,
